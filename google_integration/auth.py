...
class GoogleAuth:
    ...
    def get_auth_url(self) -> str:
        ...
        # Store the flow on the instance so exchange_code() reuses the same
        # PKCE code_verifier that was included in the authorization URL.
        self._pending_flow = self._build_flow()
    ...
    def exchange_code(self, code: str) -> None:
        ...
        flow = getattr(self, "_pending_flow", None) or self._build_flow()
    ...
    def _save_credentials(self, creds) -> None:
        """Persist credentials to token_path as JSON (owner-only permissions)."""
        import os
