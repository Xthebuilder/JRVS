...
export class JarvisAPI {
  ...
  constructor(baseUrl: string = API_BASE_URL) {
    ...
    // Read optional API token from env (set NEXT_PUBLIC_JRVS_API_TOKEN in .env.local)
    this.apiToken = process.env.NEXT_PUBLIC_JRVS_API_TOKEN || null;
  }

  /** Inject an API token at runtime (e.g. from a login form). */
